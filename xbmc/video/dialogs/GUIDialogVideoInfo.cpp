...
bool CGUIDialogVideoInfo::UpdateVideoItemTitle(const CFileItem* pItem)
{
...
bool CGUIDialogVideoInfo::UpdateVideoItemSortTitle(const CFileItem* pItem)
{
  // dont allow update while scanning
  if (g_application.IsVideoScanning())
  {
...
bool CGUIDialogVideoInfo::LinkMovieToTvShow(const CFileItem *item, bool bRemove, CVideoDatabase &database)
{
  int dbId = item->GetVideoInfoTag()->m_iDbId;
